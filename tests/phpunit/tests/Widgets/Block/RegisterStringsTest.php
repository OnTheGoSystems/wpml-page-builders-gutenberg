...
class RegisterStringsTest extends \OTGS_TestCase {
	 ...
	 * @test
	 */
	public function it_registers_strings_and_regenerates_translated_option_when_widget_blocks_are_updated() {
		...
		$saveTranslations->shouldReceive( 'generateOptionForLanguage' )->with( Obj::values( $blocks ), 'fr', $this->blockWidgetStrings, 1 )->times( 1 );
